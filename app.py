...
def load_accounts():
    ...
    # username: SOHAN_YT, password: sohan_yt. No separate passkey is required.
    if "masteradmin" in accounts and "SOHAN_YT" not in accounts:
        accounts["SOHAN_YT"] = accounts.pop("masteradmin")
        accounts["SOHAN_YT"]["role"] = "master"
        changed = True
    if "SOHAN_YT" not in accounts:
        accounts["SOHAN_YT"] = {"password": _hash_password("sohan_yt"), "role": "master", "email": ""}
        changed = True
    elif accounts["SOHAN_YT"].get("role") != "master":
        accounts["SOHAN_YT"]["role"] = "master"
        changed = True
    ...
    if accounts.get("SOHAN_YT", {}).get("password") != _hash_password("sohan_yt"):
        accounts["SOHAN_YT"]["password"] = _hash_password("sohan_yt")
        changed = True
...
<body>
    <div class="login-card">
        ...
        <div class="info-footer">
            <span>ⓘHi Welcome to SOHAN_YT TCP Bot control </span>
            Developer @SOHAN_YT
        </div>
    </div>
    <script>
